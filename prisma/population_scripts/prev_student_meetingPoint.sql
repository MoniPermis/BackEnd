...
INSERT INTO student (
    ...
    updated_at
             ...
             'password456',                  -- password (attention: en production, utilisez un hash)
             '0707070707',                   -- phone_number
             123456789,                      -- neph (numéro d'enregistrement préfectoral harmonisé)
...
-- 5. Insertion d'une disponibilité récurrente
...
-- 6. Insertion d'une indisponibilité
...
SELECT 'Étudiant inséré:' as info;
SELECT
    id,
    first_name,
    last_name,
...
SELECT 'Point de rendez-vous inséré:' as info;
SELECT
    id,
    instructor_id,
    latitude,
