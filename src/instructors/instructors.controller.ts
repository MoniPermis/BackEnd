...
export class InstructorsController {
  ...
  async getAvailabilities(@Param('instructorId', ParseIntPipe) instructorId: number) {
    return this.availabilityScheduleService.getAllAvailabilitiesByInstructorId(instructorId);
  }
}
